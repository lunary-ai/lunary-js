...
__name(hideOutputs, "hideOutputs");
...
var RunnableMap = class _RunnableMap extends Runnable {
  ...
  async invoke(input, options) {
    ...
    const runManager = await callbackManager_?.handleChainStart(this.toJSON(), {
      input
    }, void 0, void 0, void 0, void 0, options?.runName);
    const output = {};
    try {
...
var BasePromptTemplate = class extends Runnable {
  ...
  static async deserialize(data) {
    switch (data._type) {
      case "prompt": {
        const { PromptTemplate: PromptTemplate2 } = await import("./prompt-6AVVM6PH.js");
      ...
      case "few_shot": {
        const { FewShotPromptTemplate } = await import("./few_shot-ISBQDXTX.js");
