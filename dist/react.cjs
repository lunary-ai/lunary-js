...
var _chunkCIFZJIEEcjs = require('./chunk-CIFZJIEE.cjs');
...
function useChatMonitor() {
  ...
  const restart = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, () => {
    const newThread = _chunkCIFZJIEEcjs.browser_default.openThread();
    setThread(newThread);
    return newThread;
  }, "restart");
  const resumeThread = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, (id) => {
    const newThread = _chunkCIFZJIEEcjs.browser_default.openThread(id);
    setThread(newThread);
    return newThread;
  }, "resumeThread");
  ...
  return {
    ...
    trackFeedback: _chunkCIFZJIEEcjs.browser_default.trackFeedback,
    identify: _chunkCIFZJIEEcjs.browser_default.identify
  };
}
...
var react_default = _chunkCIFZJIEEcjs.browser_default;
