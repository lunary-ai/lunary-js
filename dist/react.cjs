...
var _chunk5XO3CFLXcjs = require('./chunk-5XO3CFLX.cjs');
...
function useChatMonitor() {
  ...
  const restart = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, () => {
    const newThread = _chunk5XO3CFLXcjs.browser_default.openThread();
    setThread(newThread);
    return newThread;
  }, "restart");
  const resumeThread = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, (id) => {
    const newThread = _chunk5XO3CFLXcjs.browser_default.openThread(id);
    setThread(newThread);
    return newThread;
  }, "resumeThread");
  ...
  return {
    ...
    trackFeedback: _chunk5XO3CFLXcjs.browser_default.trackFeedback,
    identify: _chunk5XO3CFLXcjs.browser_default.identify
  };
}
...
var react_default = _chunk5XO3CFLXcjs.browser_default;
