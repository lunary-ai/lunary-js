...
var _chunkQG5Y7JMHcjs = require('./chunk-QG5Y7JMH.cjs');
...
function useChatMonitor() {
  ...
  const restart = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, () => {
    const newThread = _chunkQG5Y7JMHcjs.browser_default.openThread();
    setThread(newThread);
    return newThread;
  }, "restart");
  const resumeThread = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, (id) => {
    const newThread = _chunkQG5Y7JMHcjs.browser_default.openThread(id);
    setThread(newThread);
    return newThread;
  }, "resumeThread");
  ...
  return {
    ...
    trackFeedback: _chunkQG5Y7JMHcjs.browser_default.trackFeedback,
    identify: _chunkQG5Y7JMHcjs.browser_default.identify
  };
}
...
var react_default = _chunkQG5Y7JMHcjs.browser_default;
