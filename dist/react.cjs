...
var _chunkGHAITZA3cjs = require('./chunk-GHAITZA3.cjs');
...
function useChatMonitor() {
  ...
  const restart = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, () => {
    const newThread = _chunkGHAITZA3cjs.browser_default.openThread();
    setThread(newThread);
    return newThread;
  }, "restart");
  const resumeThread = /* @__PURE__ */ _chunkEC6JY3PVcjs.__name.call(void 0, (id) => {
    const newThread = _chunkGHAITZA3cjs.browser_default.openThread(id);
    setThread(newThread);
    return newThread;
  }, "resumeThread");
  ...
  return {
    ...
    trackFeedback: _chunkGHAITZA3cjs.browser_default.trackFeedback,
    identify: _chunkGHAITZA3cjs.browser_default.identify
  };
}
...
var react_default = _chunkGHAITZA3cjs.browser_default;
