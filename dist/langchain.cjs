...
var require_decamelize = _chunkLZBAGBH5cjs.__commonJS.call(void 0, {
...
var require_camelcase = _chunkLZBAGBH5cjs.__commonJS.call(void 0, {
  "node_modules/camelcase/index.js"(exports, module) {
    ...
    var preserveCamelCase = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (string, toLowerCase, toUpperCase) => {
    ...
    var preserveConsecutiveUppercase = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (input, toLowerCase) => {
      LEADING_CAPITAL.lastIndex = 0;
      return input.replace(LEADING_CAPITAL, (m1) => toLowerCase(m1));
    }, "preserveConsecutiveUppercase");
    var postProcess = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (input, toUpperCase) => {
      SEPARATORS_AND_IDENTIFIER.lastIndex = 0;
      NUMBERS_AND_IDENTIFIER.lastIndex = 0;
      return input.replace(SEPARATORS_AND_IDENTIFIER, (_, identifier) => toUpperCase(identifier)).replace(NUMBERS_AND_IDENTIFIER, (m) => toUpperCase(m));
    }, "postProcess");
    var camelCase2 = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (input, options) => {
...
_chunkLZBAGBH5cjs.__name.call(void 0, getEnvironmentVariable, "getEnvironmentVariable");
...
_chunkLZBAGBH5cjs.__name.call(void 0, rng, "rng");
...
_chunkLZBAGBH5cjs.__name.call(void 0, unsafeStringify, "unsafeStringify");
...
_chunkLZBAGBH5cjs.__name.call(void 0, v4, "v4");
var v4_default = v4;

// node_modules/@langchain/core/dist/load/map_keys.js
var import_decamelize = _chunkLZBAGBH5cjs.__toESM.call(void 0, require_decamelize(), 1);
var import_camelcase = _chunkLZBAGBH5cjs.__toESM.call(void 0, require_camelcase(), 1);
function keyToJson(key, map) {
  return _optionalChain([map, 'optionalAccess', _4 => _4[key]]) || (0, import_decamelize.default)(key);
}
_chunkLZBAGBH5cjs.__name.call(void 0, keyToJson, "keyToJson");
...
_chunkLZBAGBH5cjs.__name.call(void 0, mapKeys, "mapKeys");

// node_modules/@langchain/core/dist/load/serializable.js
function shallowCopy(obj) {
  return Array.isArray(obj) ? [...obj] : { ...obj };
}
_chunkLZBAGBH5cjs.__name.call(void 0, shallowCopy, "shallowCopy");
...
_chunkLZBAGBH5cjs.__name.call(void 0, replaceSecrets, "replaceSecrets");
...
_chunkLZBAGBH5cjs.__name.call(void 0, get_lc_unique_name, "get_lc_unique_name");
var Serializable = class _Serializable {
  static {
    _chunkLZBAGBH5cjs.__name.call(void 0, this, "Serializable");
  }
  /**
...
var BaseCallbackHandlerMethodsClass = class {
  static {
    _chunkLZBAGBH5cjs.__name.call(void 0, this, "BaseCallbackHandlerMethodsClass");
  }
};
var BaseCallbackHandler = class _BaseCallbackHandler extends BaseCallbackHandlerMethodsClass {
  static {
    _chunkLZBAGBH5cjs.__name.call(void 0, this, "BaseCallbackHandler");
  }
  get lc_namespace() {
  ...
  static fromMethods(methods) {
    class Handler extends _BaseCallbackHandler {
      static {
        _chunkLZBAGBH5cjs.__name.call(void 0, this, "Handler");
      }
      constructor() {
        super();
...
// src/langchain.ts
var parseRole = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (ids) => {
...
var convertToLunaryMessages = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (input) => {
  const parseMessage = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (raw) => {
...
var parseInput = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (rawInput) => {
  if (!rawInput)
    return null;
...
var parseOutput = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (rawOutput) => {
  if (!rawOutput)
    return null;
...
var parseExtraAndName = /* @__PURE__ */ _chunkLZBAGBH5cjs.__name.call(void 0, (llm, extraParams, metadata) => {
  const params = {
...
var LunaryHandler = (_class = class extends BaseCallbackHandler {
  static {
    _chunkLZBAGBH5cjs.__name.call(void 0, this, "LunaryHandler");
  }
  __init() {this.name = "lunary_handler"}
  
  constructor(fields = {}) {
    super(fields);_class.prototype.__init.call(this);;
    this.lunary = _chunkJ4UXKIIMcjs.src_default;
    if (fields) {
