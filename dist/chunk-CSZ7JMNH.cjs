...
// src/index.ts
var BackendMonitor = class extends _chunkTUK3O2HZcjs.lunary_default {
  static {
  ...
  async executeWrappedFunction(target) {
    ...
    const runId2 = _chunkTUK3O2HZcjs.generateUUID.call(void 0, );
    ...
    const input = inputParser ? inputParser(...args) : _chunkTUK3O2HZcjs.getFunctionInput.call(void 0, func, args);
    if (track !== false) {
    ...
    try {
      ...
      if (track !== false) {
        this.trackEvent(type, "error", {
          runId: runId2,
          error: _chunkTUK3O2HZcjs.cleanError.call(void 0, error)
        });
