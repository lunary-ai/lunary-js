...
_chunkQLHFAYNHcjs.__name.call(void 0, identify, "identify");
...
_chunkQLHFAYNHcjs.__name.call(void 0, setParent, "setParent");
...
// src/index.ts
var BackendMonitor = class extends _chunkQLHFAYNHcjs.llmonitor_default {
  static {
    _chunkQLHFAYNHcjs.__name.call(void 0, this, "BackendMonitor");
  }
  wrap(type, func, params) {
    const llmonitor2 = this;
    const wrappedFn = /* @__PURE__ */ _chunkQLHFAYNHcjs.__name.call(void 0, (...args) => {
      const callInfo = {
        type,
        func,
        args,
  ...
  async executeWrappedFunction(target) {
    ...
    const input = inputParser ? inputParser(...args) : _chunkQLHFAYNHcjs.getFunctionInput.call(void 0, func, args);
    ...
    const processOutput = /* @__PURE__ */ _chunkQLHFAYNHcjs.__name.call(void 0, async (output) => {
    ...
    try {
      ...
      this.trackEvent(type, "error", {
        runId: runId2,
        error: _chunkQLHFAYNHcjs.cleanError.call(void 0, error)
      });
