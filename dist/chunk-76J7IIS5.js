...
var processRegExp = /* @__PURE__ */ __name((regex, refs) => {
...
var BasePromptTemplate = class extends Runnable {
  ...
  static async deserialize(data) {
    switch (data._type) {
      case "prompt": {
        const { PromptTemplate: PromptTemplate2 } = await import("./prompt-5BCMMESJ.js");
      ...
      case "few_shot": {
        const { FewShotPromptTemplate } = await import("./few_shot-DZ4L7FZ7.js");
...
var interpolateMustache = /* @__PURE__ */ __name((template, values) => mustache_default.render(template, values), "interpolateMustache");
