...
// src/openai.ts
var parseOpenaiMessage = /* @__PURE__ */ _chunkLBN5CM5Xcjs.__name.call(void 0, (message) => {
  if (!message)
    return void 0;
...
var teeAsync = /* @__PURE__ */ _chunkLBN5CM5Xcjs.__name.call(void 0, (iterable) => {
  ...
  _chunkLBN5CM5Xcjs.__name.call(void 0, makeIterator, "makeIterator");
...
function openAIv3(openai, params = {}) {
  ...
  const wrapped = _chunkPTS43ODPcjs.src_default.wrapModel(createChatCompletion, {
    ...
    extraParser: (request) => {
      ...
      return _chunkLBN5CM5Xcjs.cleanExtra.call(void 0, rawExtra);
    },
...
_chunkLBN5CM5Xcjs.__name.call(void 0, openAIv3, "openAIv3");
function monitorOpenAI(openai, params = {}) {
  const createChatCompletion = openai.chat.completions.create;
  const wrappedCreateChatCompletion = /* @__PURE__ */ _chunkLBN5CM5Xcjs.__name.call(void 0, (...args) => (
    // @ts-ignore
  ...
  _chunkLBN5CM5Xcjs.__name.call(void 0, handleStream, "handleStream");
  const wrapped = _chunkPTS43ODPcjs.src_default.wrapModel(wrappedCreateChatCompletion, {
    nameParser: (request) => request.model,
    inputParser: (request) => request.messages.map(parseOpenaiMessage),
    extraParser: (request) => {
      const rawExtra = {};
...
_chunkLBN5CM5Xcjs.__name.call(void 0, monitorOpenAI, "monitorOpenAI");
