...
var _chunkBD6OP4WRcjs = require('./chunk-BD6OP4WR.cjs');
...
// src/openai.ts
var parseOpenaiMessage = /* @__PURE__ */ _chunkVHNQ7HKDcjs.__name.call(void 0, (message) => {
  if (!message)
    return void 0;
...
var teeAsync = /* @__PURE__ */ _chunkVHNQ7HKDcjs.__name.call(void 0, (iterable) => {
  ...
  _chunkVHNQ7HKDcjs.__name.call(void 0, makeIterator, "makeIterator");
...
function openAIv3(openai, params = {}) {
  ...
  const wrapped = _chunkBD6OP4WRcjs.src_default.wrapModel(createChatCompletion, {
    ...
    extraParser: (request) => {
      ...
      return _chunkVHNQ7HKDcjs.cleanExtra.call(void 0, rawExtra);
    },
...
_chunkVHNQ7HKDcjs.__name.call(void 0, openAIv3, "openAIv3");
function monitorOpenAI(openai, params = {}) {
  const createChatCompletion = openai.chat.completions.create;
  const wrappedCreateChatCompletion = /* @__PURE__ */ _chunkVHNQ7HKDcjs.__name.call(void 0, (...args) => (
    // @ts-ignore
  ...
  _chunkVHNQ7HKDcjs.__name.call(void 0, handleStream, "handleStream");
  const wrapped = _chunkBD6OP4WRcjs.src_default.wrapModel(wrappedCreateChatCompletion, {
    nameParser: (request) => request.model,
    inputParser: (request) => request.messages.map(parseOpenaiMessage),
    extraParser: (request) => {
      const rawExtra = {};
...
_chunkVHNQ7HKDcjs.__name.call(void 0, monitorOpenAI, "monitorOpenAI");
