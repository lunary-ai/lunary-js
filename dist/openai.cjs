...
var _chunk7KEMQBU7cjs = require('./chunk-7KEMQBU7.cjs');

// src/openai.ts
var parseOpenaiMessage = /* @__PURE__ */ _chunk7KEMQBU7cjs.__name.call(void 0, (message) => {
  if (!message)
    return void 0;
...
var teeAsync = /* @__PURE__ */ _chunk7KEMQBU7cjs.__name.call(void 0, (iterable) => {
  ...
  _chunk7KEMQBU7cjs.__name.call(void 0, makeIterator, "makeIterator");
...
function openAIv3(openai, params = {}) {
  ...
  const wrapped = _chunk7KEMQBU7cjs.src_default.wrapModel(createChatCompletion, {
    ...
    extraParser: (request) => {
      ...
      return _chunk7KEMQBU7cjs.cleanExtra.call(void 0, rawExtra);
    },
...
_chunk7KEMQBU7cjs.__name.call(void 0, openAIv3, "openAIv3");
function monitorOpenAI(openai, params = {}) {
  ...
  _chunk7KEMQBU7cjs.__name.call(void 0, handleStream, "handleStream");
  const wrapped = _chunk7KEMQBU7cjs.src_default.wrapModel(createChatCompletion, {
    nameParser: (request) => request.model,
    inputParser: (request) => request.messages.map(parseOpenaiMessage),
    extraParser: (request) => {
...
_chunk7KEMQBU7cjs.__name.call(void 0, monitorOpenAI, "monitorOpenAI");
