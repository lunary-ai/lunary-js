...
var LLMonitor = class {
  ...
  wrap(type, func, params) {
    return async (...args) => {
      ...
      const parentId = context_default.tryUse();
  ...
  langchain(baseClass) {
    ...
    return class extends baseClass {
      constructor(...args) {
        super(...args);
        __publicField(this, "interestingArgs");
      ...
      async call(...args) {
        ...
        return await monitor2.wrapModel(boundSuperCall, {
          name: this.interestingArgs?.modelName
        })(...args);
      }
    };
  }
